...
In comparison to our Baseline Model's $R^2$ of `0.00015936555775553085`, the Final Model's $R^2$ value is significantly larger. These indicates that the Final Model improved greatly from our Baseline as we tried fitting more features (reducing variance) and transforming them so that they reflect better in the model.
## Fairness Analysis
